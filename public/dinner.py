...
#Step 5: Ask for second side
side_two = input("What is your second_second side?: ")

#Step 6: Ask for the first desert
dessert_one = input("What is your first dessert?: ")

#Step 7: Ask for the second desert
dessert_two = input("What is your second desert?: ")

#Step 8: Ask for the third desert
